...
const QrcodeMarkingNew = () => {
  ...
  const [qrValue, setQrValue] = useState("https://navnitam.netlify.app/");
  useEffect(() => {
  ...
  const downloadQRCode = () => {
    ...
    downloadLink.download = `${sessionName.current?.value + "Qr"}.png`;
  ...
  return (
    <div className="mx-auto fon    mx-2 border bg-white p-4">
      ...
      <div class="font-semibold mt-6">Scan this Qr code for attendance</div>
      ...
      <div class="flex ">
        <div
          class=" flex items-center cursor-pointer rounded-[4px] bg-green-700 px-3 py-[6px] text-center font-semibold text-white"
        ...
        <div
          class="ml-6 flex items-center cursor-pointer rounded-[4px] bg-green-700 px-3 py-[6px] text-center font-semibold text-white"
          onClick={() => {
            const canvas = document.getElementById("qr-gen");
            const pngUrl = canvas
              .toDataURL("image/png")
